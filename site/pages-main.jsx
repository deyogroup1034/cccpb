          ...
          <div className="hero__grid">
            <div>
              ...
              <h1 className="hero__title">
                A morning of <em>grace,</em><br/>
                gratitude &amp;<br/>
                <em>good company.</em>
              </h1>
              <p className="hero__sub">
                Join hundreds of Collin County neighbors before sunrise on the National Day of Prayer for fellowship, scripture, music — and a keynote testimony from former Texas Ranger <b>Elvis Andrus</b>.
              </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, border: '1px solid var(--ink)' }} className="cta-grid">
            <div style={{ padding: '64px 56px', background: 'var(--ink)', color: 'var(--cream)' }}>
              ...
              <h2 style={{ marginTop: 18, color: 'var(--bone)', fontFamily: 'var(--serif)' }}>
                ...
                <em style={{ color: 'var(--gold-soft)' }}>Bring everyone you love.</em>
              </h2>
      ...
      <section className="section">
        <div className="container container--narrow" style={{ textAlign: 'center' }}>
          ...
          <h1 style={{ marginTop: 22, fontSize: 'clamp(48px, 5.4vw, 80px)' }}>
            A county <em style={{ color: 'var(--oxblood)' }}>kneeling together</em><br/> since 1999.
          </h1>
          <p style={{ marginTop: 28, fontSize: 19, color: 'var(--ink-2)', lineHeight: 1.65, maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' }}>
            What began as seven business leaders gathered around a single breakfast table has grown into one of North Texas’s longest‑running annual prayer gatherings.
          </p>
        </div>
      </section>
