...
function CountdownBar({ go }) {
  ...
  return (
    <div className="countdown-bar" data-screen-label="countdown bar">
      <span className="countdown-bar__lbl">{event.edition} • {event.dateLabel}</span>
                ...
                >
                  ...
                  {open && (
                    <div style={{
                      ...
                      boxShadow: '0 20px 50px -10px rgba(11,18,32,0.18), 0 4px 14px -4px rgba(11,18,32,0.10)',
    ...
    <footer className="foot" data-screen-label="footer">
      <div className="container">
        <div className="foot__grid">
          <div>
            <div className="foot__title">{event.name}</div>
            <p style={{ opacity: 0.7, fontSize: 14, maxWidth: 360, lineHeight: 1.6 }}>
              An annual gathering of Collin County for fellowship, scripture, and the quiet work of saying grace together. Since {event.founded}.
            </p>
          ...
          <div>
            ...
            <div className="foot__list">
              ...
              <span style={{ opacity: 0.6, fontSize: 13 }}>{event.venueAddr}</span>
              <span style={{ opacity: 0.6, fontSize: 13 }}>{event.venueCity}</span>
        ...
        {lines.length > 0 && (
          <div className="drawer__foot">
            ...
            <p style={{ fontSize: 11, color: 'var(--muted)', textAlign: 'center', marginTop: 12 }}>
              Secure checkout. Your seats are not confirmed until payment is complete.
            </p>
          </div>
        )}
      </aside>
...
Object.assign(window, { CountdownBar, Nav, Footer, CartDrawer, useCountdown, Logo });
