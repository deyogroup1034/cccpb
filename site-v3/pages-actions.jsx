      ...
      <section className="section" style={{ background: 'var(--ink)', color: 'var(--cream)' }}>
        <div className="container container--narrow" style={{ textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 40, display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32, textAlign: 'left' }} className="other-give-grid">
            {[
              { t: 'By Check', b: 'Make payable to "CCCPB" and mail to PO Box 261324, Plano, TX 75026.' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '5fr 7fr', gap: 64, alignItems: 'center' }} className="loc-grid">
            <div>
              ...
              <div style={{ marginTop: 32, display: 'flex', gap: 14 }}>
                <a className="btn btn--oxblood" href="https://www.google.com/maps/place/Plano+Centre" target="_blank">Open in Google Maps ↗</a>
              </div>
            </div>
            ...
            <div style={{ position: 'relative', aspectRatio: '4/5' }}>
              <div style={{
                ...
                background: `
                  repeating-linear-gradient(90deg, rgba(11,18,32,0.05) 0, rgba(11,18,32,0.05) 1px, transparent 1px, transparent 40px),
                  repeating-linear-gradient(0deg, rgba(11,18,32,0.05) 0, rgba(11,18,32,0.05) 1px, transparent 1px, transparent 40px),
                ...
                <svg viewBox="0 0 400 500" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
                  <path d="M0,180 Q120,160 220,200 T400,180" stroke="rgba(59,107,214,0.4)" strokeWidth="20" fill="none" />
                  <path d="M0,180 Q120,160 220,200 T400,180" stroke="var(--cream)" strokeWidth="14" fill="none" />
                  <path d="M180,0 Q160,150 220,280 T240,500" stroke="rgba(59,107,214,0.4)" strokeWidth="20" fill="none" />
                  <path d="M180,0 Q160,150 220,280 T240,500" stroke="var(--cream)" strokeWidth="14" fill="none" />
                  <path d="M0,360 L400,340" stroke="rgba(11,18,32,0.18)" strokeWidth="2" fill="none" />
                  <path d="M40,0 L60,500" stroke="rgba(11,18,32,0.18)" strokeWidth="2" fill="none" />
                </svg>
                {/* pin */}
